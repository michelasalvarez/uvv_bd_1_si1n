...
COMMENT ON COLUMN hr.empregados.id_regiao IS 'Id_empregado será a PK da tabela';
...
COMMENT ON COLUMN hr.historico_cargos.data_incial IS 'data_incial será uma PK composta na tabela';
